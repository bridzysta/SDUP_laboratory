...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L blk_mem_gen_v8_4_3 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mb_design xil_defaultlib.mb_design xil_defaultlib.glbl -log elaborate.log
}
