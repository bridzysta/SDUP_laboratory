...
execute()
{
  irun $irun_opts \
       ...
       -top xil_defaultlib.mb_design \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"../../../../cordic_acc.srcs/sources_1/bd/mb_design/ipshared/c923" \
       +incdir+"../../../../cordic_acc.srcs/sources_1/bd/mb_design/ipshared/ec67/hdl"
}
