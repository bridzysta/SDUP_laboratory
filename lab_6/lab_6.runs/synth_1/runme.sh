...
HD_PWD='C:/__Programowanie__/Repozytoria/SDUP_laboratory/lab_6/lab_6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mul12.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mul12.tcl
