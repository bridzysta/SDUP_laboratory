...
HD_PWD='C:/__Programowanie__/Repozytoria/SDUP_laboratory/laboratory_5/laboratory_5.runs/stream_acc_design_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stream_acc_design_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stream_acc_design_rst_ps7_0_100M_0.tcl
