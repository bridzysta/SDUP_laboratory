...
HD_PWD='C:/__Programowanie__/Repozytoria/SDUP_laboratory/laboratory_5/laboratory_5.runs/stream_acc_design_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stream_acc_design_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stream_acc_design_auto_pc_0.tcl
