...
HD_PWD='C:/__Programowanie__/Repozytoria/SDUP_laboratory/laboratory_5/laboratory_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stream_acc_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stream_acc_design_wrapper.tcl -notrace
