...
ISEStep( "vivado",
         "-log stream_acc_design_cordic_stream_acc_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stream_acc_design_cordic_stream_acc_0_0.tcl" );
