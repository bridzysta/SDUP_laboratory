...
HD_PWD='C:/__Programowanie__/Repozytoria/SDUP_laboratory/laboratory_5/laboratory_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stream_acc_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stream_acc_design_wrapper.tcl
